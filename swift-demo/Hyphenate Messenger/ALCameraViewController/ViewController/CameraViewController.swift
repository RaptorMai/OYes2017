...
open class CameraViewController: UIViewController {
    ...
    public init(croppingEnabled: Bool, allowsLibraryAccess: Bool = true, allowsSwapCameraOrientation: Bool = false, completion: @escaping CameraViewCompletion) {
...
//  In the process of writing delegate decided not to write it anymore

...
- (void)drawInContext:(CGContextRef)context
{
    ...
    CGFloat radians = (progress * 2.0f * M_PI) - M_PI / 2;
    
    CGContextSetFillColorWithColor(context, self.trackTintColor.CGColor);
    CGMutablePathRef trackPath = CGPathCreateMutable();
    CGPathMoveToPoint(trackPath, NULL, centerPoint.x, centerPoint.y);
    CGPathAddArc(trackPath, NULL, centerPoint.x, centerPoint.y, radius, 3.0f * M_PI / 2, - M_PI / 2, NO);
    ...
    if (progress > 0.0f)
    {
        ...
        CGPathAddArc(progressPath, NULL, centerPoint.x, centerPoint.y, radius, 3.0f * M_PI / 2, radians, NO);

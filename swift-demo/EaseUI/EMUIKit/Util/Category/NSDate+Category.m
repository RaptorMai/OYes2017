...
- (NSString *)minuteDescription
{
    ...
    if ([theDay isEqualToString:currentDay]) {//the same day
    ...
    } else if ([[dateFormatter dateFromString:currentDay] timeIntervalSinceDate:[dateFormatter dateFromString:theDay]] < 86400 * 7) {//within a week ago
...
- (NSString *)formattedDateDescription
{
    ...
    if (timeInterval < 60) {
        ...
        return [NSString stringWithFormat:NSEaseLocalizedString(@"NSDateCategory.text2", @""), timeInterval / 60];
	} else if (timeInterval < 21600) {//within 6 hours
        return [NSString stringWithFormat:NSEaseLocalizedString(@"NSDateCategory.text3", @""), timeInterval / 3600];
	} else if ([theDay isEqualToString:currentDay]) {//the same day
